...
public class MeetingroomController {
    ...
    @GetMapping("")
    public String toMeetingroomListUI(){
        return "meeting/meetingroomlist";
    }
    
    
    @GetMapping("/list")
    @ResponseBody
    public Result<Object> getmeetingroomList(MeetingRoomQuery param){
        List<MeetingRoom> list = meetingService.getMeetingRoomList(param);
        Long count = meetingService.countMeetingRoomList(param);
